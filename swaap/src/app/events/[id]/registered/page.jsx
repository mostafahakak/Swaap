...
export default function EventRegisteredPage() {
  return (
    <div className="mx-auto max-w-md px-4 py-16 text-center">
      ...
      <h1 className="mt-6 text-2xl font-semibold text-black">You're registered</h1>
      <p className="mt-3 text-neutral-600">
        We've added this event to your schedule. You'll receive a reminder before it starts.
      </p>
